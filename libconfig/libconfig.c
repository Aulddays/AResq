...
const char *config_get_string(const config_t *config, const char *path, const char *defval)
{
	const char *ret = NULL;
	if (CONFIG_FALSE != config_lookup_string(config, path, &ret))
		return ret;
	return defval;
}
...
int config_get_int(const config_t *config, const char *path, int defval)
{
	int ret = defval;
	if (CONFIG_FALSE != config_lookup_int(config, path, &ret))
		return ret;
	return defval;
}
/* ------------------------------------------------------------------------- */
...
bool config_get_bool(const config_t *config, const char *path, bool defval)
{
	int ret = false;
	if (CONFIG_FALSE != config_lookup_bool(config, path, &ret))
		return ret != 0;
	return defval;
}
/* ------------------------------------------------------------------------- */
